...
<body>
    ...
    <form method="POST">
        <textarea name="input" placeholder="Enter a topic for your poem..."></textarea><br>
...
def index():
    ...
    if request.method == "POST":
        try:
            ...
            model_name = os.getenv("MODEL_OLLAMA", "llama3")

            response = client.chat.completions.create(
                model=model_name,
                messages=[
                    {"role": "system", "content": "You are a creative AI that writes beautiful, meaningful poems based on topics."},
                    {"role": "user", "content": f"Write a poem about: {input_message}"}
                ]
            )
            ...
            print("Error: ", str(e))
            poem = "An error occurred while we were trying to generate your poem."
